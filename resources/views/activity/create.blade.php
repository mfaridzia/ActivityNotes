    ...
    <div class="row">
       <div class="col-md-8 col-xs-12 col-md-offset-2">
        <div class="panel panel-default">
            ...
            <div class="white-box">
                <form class="form-horizontal form-material" method="POST" action="/activity">
                    {{ csrf_field() }}

                    <div class="form-group{{ $errors->has('activity_name') ? ' has-error' : '' }}">
                        <label class="col-md-12">Event Name</label>
                        <div class="col-md-12">
                            <input type="text" name="activity_name" placeholder="" class="form-control form-control-line"  required> 
